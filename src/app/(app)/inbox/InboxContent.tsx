      ...
      <CardContent className="p-4 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] items-center justify-items-center gap-4">
            ...
            <div className="flex items-center gap-4">
                <div className="w-24 h-24 rounded-lg overflow-hidden relative border shrink-0">
                    ...
                    <div className="text-left">
                        <p className="text-sm font-medium">{theirItem?.title ?? 'Unknown Item'}</p>
                        <p className="text-xs text-muted-foreground">{theirItem?.category ?? 'Uncategorized'}</p>
                    </div>
                </div>
          </div>
          ...
          <div className="flex flex-col items-center gap-2 text-center w-full">
            ...
            <div className="flex items-center gap-4">
                <div className="w-24 h-24 rounded-lg overflow-hidden relative border shrink-0">
                    {yourItemImage && yourItem && (
                        <Image
                            src={yourItemImage}
                            alt={yourItem?.title ?? 'Your item'}
                            fill
                            className="object-cover"
                        />
                    )}
                    ...
                    <div className="text-left">
                        <p className="text-sm font-medium">{yourItem?.title ?? 'Unknown Item'}</p>
                        <p className="text-xs text-muted-foreground">{yourItem?.category ?? 'Uncategorized'}</p>
                </div>
            </div>
          </div>
        </div>

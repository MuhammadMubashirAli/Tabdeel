                            ...
                            >
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center text-center md:text-left">
                                    <div className="space-y-4 text-white">
                                        ...
                                        <p className="text-sm md:text-base text-neutral-300">{step.description}</p>
                                    </div>
                                    <div className="relative aspect-square w-full max-w-[8rem] sm:max-w-xs mx-auto md:max-w-md">
                                        {step.image && (
                                            <Image
                                                src={step.image}
                                                alt={step.title}

...
export function HowItWorks() {
    ...
    const opacityFirst = useTransform(scrollYProgress, [0.1, 0.2, 0.25], [1, 1, 0]);
    ...
    const opacityFourth = useTransform(scrollYProgress, [0.7, 0.8, 1], [0, 1, 1]);
    ...
    return (
        <section ref={targetRef} id="how-it-works" className="w-full relative h-[400vh]">
            <div className="sticky top-0 h-screen bg-black flex flex-col items-center justify-start pt-24 overflow-hidden">
